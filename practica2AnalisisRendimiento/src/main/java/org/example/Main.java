...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tiempo de ejecución de la suma Paralela con (2) hilos: " + (tiempoFinal - tiempoInicio) + "ms");
        System.out.println("---------------------------------------------");
        ...
        System.out.println("Tiempo de ejecución de la suma Paralela con (4) hilos: " + (tiempoFinal - tiempoInicio) + "ms");
        System.out.println("---------------------------------------------");
        ...
        System.out.println("Tiempo de ejecución de la suma Paralela con (8) hilos: " + (tiempoFinal - tiempoInicio) + "ms");
        System.out.println("---------------------------------------------");
